...
DEFAULT_CHAT_INSTRUCTION = (
    ...
    "IMPORTANT cần upsell sản phẩm nếu khách hàng do dự hoặc không muốn mua, nhưng lại có sản phẩm có khả năng phù hợp, IMPORTANT thật quan tâm đến nhu cầu của khách hàng"
